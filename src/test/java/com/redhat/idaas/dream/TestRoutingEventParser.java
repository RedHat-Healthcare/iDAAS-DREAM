...
public class TestRoutingEventParser extends CamelTestSupport {
	...
	protected RouteBuilder createRouteBuilder() {
		return new RouteBuilder() {
			...
			from("direct:routingEventParserRoute")
				.log(LoggingLevel.INFO, logger, "${body}")
				.bean(RoutingEventParser.class, "buildRoutingEvent(${body})")
				.log(LoggingLevel.INFO, logger, "${bodyAs(com.redhat.idaas.pojos.platform.RoutingEvent)}");
			}
		};
	}

	@Test
    public void testRoutingEventParserRoute() throws Exception {
